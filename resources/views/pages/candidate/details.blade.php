...
<head>
    ...
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="{{asset('resume/css/pillar-1.css')}}">
		    ...
		    <header class="resume-header pt-4 pt-md-0">
			    <div class="row">
				    <div class="col-block col-md-auto resume-picture-holder text-center text-md-start">
				        <img class="picture" src="{{asset('resume/images/profile.jpg')}}" alt="">
				    </div><!--//col-->
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">{{$candidate->full_name}}</h1>
							    <div class="title mb-3">{{$candidate->posisition_applied}}</div>
							    <ul class="list-unstyled">
								    ...
								    <li><a class="text-link" href="#"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>{{$candidate->phone_number}}</a></li>
							    </ul>
						    </div><!--//primary-info-->
								    ...
								    <article class="resume-timeline-item position-relative pb-5">
									    <div class="resume-timeline-item-header mb-2">
										    <div class="d-flex flex-column flex-md-row">
										        <h3 class="resume-position-title font-weight-bold mb-1">{{ $data->posisition }}</h3>
										        <div class="resume-company-name ms-auto">{{ $data->company_name }}</div>
										    </div><!--//row-->
										    <div class="resume-position-time">{{ $data->date_start }} - {{ $data->date_end }}</div>
									    </div><!--//resume-timeline-item-header-->
									    <div class="resume-timeline-item-desc">
										    <p>{{ $data->job_desc }}</p>
										    <h4 class="resume-timeline-item-desc-heading font-weight-bold">Reason For Leaving:</h4>
										    <p>{{ $data->reason_leaving }}</p>
